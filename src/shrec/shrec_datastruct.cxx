/// \file shrec_datastruct.cxx
/// shrec data structures
...
// Initialize SHREC_PARAM
void SHREC_PARAM::Init()
{
...
void SHREC_PARAM::SetInterpolationType
...
void SHREC_PARAM::SetVertexPositionMethod
...
void SHREC_PARAM::SetUseSelectedGradients
(const bool flag)
{
...
void SHREC_PARAM::SetUseOnlyCubeGradients
(const bool flag)
{
...
void SHREC_PARAM::SetUseIntersectedEdgeEndpointGradients
(const bool flag)
{
...
/// Set
void SHREC_PARAM::Set
(const SHREC_PARAM & param)
{
  *this = param;
}

/// Return true if gradient data required.
bool SHREC_PARAM::GradientsRequired() const
{
...
bool SHREC_PARAM::NormalsRequired() const
{
...
// Initialize SHREC_DATA
void SHREC_DATA::Init()
{
...
// Copy scalar grid
void SHREC_DATA::CopyScalarGrid
...
// Copy gradient grid
void SHREC_DATA::CopyGradientGrid
...
void SHREC_DATA::SubsampleScalarGrid
...
void SHREC_DATA::SupersampleScalarGrid
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid2, 
...
void SHREC_DATA::SubsampleGradientGrid
...
{
  PROCEDURE_ERROR error("SHREC_DATA::SetScalarGrid");
...
void SHREC_DATA::SetGrids
(const SHARPISO_SCALAR_GRID_BASE & full_scalar_grid,
 const GRADIENT_GRID_BASE & full_gradient_grid,
 const bool flag_subsample, const int subsample_resolution,
 const bool flag_supersample, const int supersample_resolution)
{
  PROCEDURE_ERROR error("SHREC_DATA::SetGrids");
...
bool SHREC_DATA::Check(IJK::ERROR & error) const
{
  IJK::ERROR error2;
...
SHREC::SHREC_TIME::SHREC_TIME()
// constructor
{
  Clear();
}

void SHREC::SHREC_TIME::Clear()
{
  preprocessing = 0.0;
  extract = 0.0;
  merge_identical = 0.0;
...
void SHREC::SHREC_TIME::Add(const SHREC_TIME & isodual_time)
{
...
SHREC::GRID_INFO::GRID_INFO()
{
  Clear();
}

void SHREC::GRID_INFO::Clear()
{
  num_cubes = 0;
}

void SHREC::SCALAR_INFO::Init(const int dimension)
{
  this->dimension = 0;
...
void SHREC::SCALAR_INFO::FreeAll()
{
  dimension = 0;
}

void SHREC::SCALAR_INFO::Clear()
{
  num_non_empty_cubes = 0;
  num_bipolar_edges = 0;
}

void SHREC::SCALAR_INFO::SetDimension(const int dimension)
{
  FreeAll();
...
void SHREC::SCALAR_INFO::Copy(const SCALAR_INFO & info)
{
  Init(info.Dimension());
...
/// Copy assignment.
const SCALAR_INFO &  SHREC::SCALAR_INFO::operator =
...
SHREC::SHREC_INFO::SHREC_INFO()
{
  Clear();
}

void SHREC::SHARPISO_INFO::Clear()
{
  ISOVERT_INFO::Clear();
...
void SHREC::DUAL_ISOVERT_INFO::Set(const SHREC::DUAL_ISOVERT & isov)
{
...
bool SHREC::MERGE_DATA::Check(ERROR & error) const
{
  if (MaxNumInt() <
