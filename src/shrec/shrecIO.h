/// \file shrecIO.h
/// IO classes and routines for shrec.
...
namespace SHREC {
  ...
  /// IO information
  class IO_INFO:public SHREC_PARAM {
  ...
  public:
    ...
    /// Use isovalue in output filename.
    bool flag_use_isovalue_in_output_filename;
  ...
  public:
    ...
    bool is_cube_selection_method_set;
    bool is_flag_map_extended_set;
    bool is_max_dist_set;
    bool is_max_small_eigenvalue_set;
    bool is_grad_selection_cube_offset_set;

    bool flag_output_help;
    bool flag_list_all_options;
  ...
  /// Set shrec_data based on input_info.
  /// Precondition: Scalar field in shrec_data must be set before
  ...
  /// Report shrec parameters.
  void report_shrec_param(const SHREC_PARAM & shrec_param);
  ...
  void usage_error(const char * command_name, 
                   const bool flag_list_all_options=false);
  void help(const char * command_name,
            const bool flag_list_all_options=false);
  void help_output(const char * command_name);
  void help_testing(const char * command_name);
}
