/// \file shrec_datastruct.h
/// Data structure definitions for shrec.
...
#ifndef _SHREC_DATASTRUCT_
#define _SHREC_DATASTRUCT_
...
namespace SHREC {
  ...
  class SHREC_PARAM:public SHREC::MERGE_PARAM {
  ...
  public:
    ...
    /// Set
    void Set(const SHREC_PARAM & param);
  ...
  class SHREC_DATA:public SHREC_PARAM {
  ...
  public:
    ...
    // Set functions
    void CopyScalarGrid             /// Copy scalar_grid to SHREC_DATA
      (const SHARPISO_SCALAR_GRID_BASE & scalar_grid2);
    void CopyGradientGrid             /// Copy gradient_grid to SHREC_DATA
  ...
  public:
    ...
    SHREC_TIME();
    void Clear();
    void Add(const SHREC_TIME & isodual_time);
  };
  ...
  public:
    ...
    void Set(const SHREC::DUAL_ISOVERT & isov);
  };
  ...
  public:
    ...
    SHREC_INFO();
    SHREC_INFO(const int dimension);
  ...
  typedef MESH_VERTEX_LIST<int, COORD_TYPE, SCALAR_TYPE> 
    SHREC_MESH_VERTEX_LIST;    ///< Dual Contouring mesh vertex list.
