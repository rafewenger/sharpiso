...
void SHREC::position_dual_isovertices_cube_center
...
void SHREC::position_dual_isovertices_centroid
...
void SHREC::position_dual_isovertices_centroid_multi
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
 ...
 COORD_TYPE * coord)
{
  ...
  SHREC_CUBE_FACE_INFO  cube(dimension);
...
void SHREC::position_merged_dual_isovertices_multi
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
 const IJKDUALTABLE::ISODUAL_CUBE_TABLE & isodual_table,
 const SCALAR_TYPE isovalue,
...
// Allows multiple vertices in a grid cube.
void SHREC::position_dual_isovertices_multi
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
 const IJKDUALTABLE::ISODUAL_CUBE_TABLE & isodual_table,
 const SCALAR_TYPE isovalue,
 const ISOVERT & isovert,
...
/// Position vertices using SVD on grid edge-isosurface intersections.
void SHREC::position_dual_isovertices_edgeI
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
    ...
    for (VERTEX_INDEX i = 0; i<vlist.size(); i++) {
      ...
      svd_compute_sharp_vertex_edgeI_sharp_gradient
        (scalar_grid, gradient_grid, iv, isovalue,
         shrec_param, sharp_coord+i*DIM3,
 ...
 SHARPISO_INFO & sharp_info)
{
  ...
  position_dual_isovertices_edgeI
    (scalar_grid, gradient_grid, isovalue, shrec_param, vlist,
...
void SHREC::position_dual_isovertices_edgeI_multi
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
 const GRADIENT_GRID_BASE & gradient_grid,
 const IJKDUALTABLE::ISODUAL_CUBE_TABLE & isodual_table,
 const SCALAR_TYPE isovalue,
 ...
 SHARPISO_INFO & sharp_info)
{
  ...
  for (VERTEX_INDEX i = 0; i < iso_vlist.size(); i++) {
    ...
    if (isodual_table.NumIsoVertices(it) == 1) {
      ...
      if (position_method == EDGEI_GRADIENT) {
        svd_compute_sharp_vertex_edgeI_sharp_gradient
          (scalar_grid, gradient_grid, icube, isovalue, shrec_param,
 ...
 SHARPISO_INFO & sharp_info)
{
  ...
  position_dual_isovertices_edgeI_multi
    (scalar_grid, gradient_grid, isodual_table, isovalue, shrec_param, 
...
void SHREC::compute_isosurface_grid_edge_centroid
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
...
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
 ...
 const SHREC_CUBE_FACE_INFO & cube,
 COORD_TYPE * coord)
{
...
void SHREC::split_dual_isovert_ambig
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
 const IJKDUALTABLE::ISODUAL_CUBE_TABLE & isodual_table,
 const SCALAR_TYPE isovalue,
...
// @param isodual_table Dual isosurface lookup table.
void SHREC::full_split_dual_isovert
(const SHARPISO_SCALAR_GRID_BASE & scalar_grid,
 const IJKDUALTABLE::ISODUAL_CUBE_TABLE & isodual_table,
 const SCALAR_TYPE isovalue,
 const ISOVERT & isovert,
 ...
 SHARPISO_INFO & sharp_info)
{
  ...
  int num_split;
  if (shrec_param.flag_split_non_manifold) {
 ...
 SHARPISO_INFO & sharp_info)
{
  ...
  full_split_dual_isovert
    (scalar_grid, isodual_table,isovalue, isovert, isoquad_cube, facet_vertex,
     shrec_param, table_index, iso_vlist, isoquad_vert, sharp_info);
}
...
void SHREC::copy_isovert_positions
