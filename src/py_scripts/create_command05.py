...
def create_iso_command_negate(args):
  outlist=[]
  #read the data sheet info 
  fda=open ('testData/data_sheet.txt','r')
  print 'create_iso_command_negative gradients'
  for pos in args.position:
    ...
    for infile in args.input_files:
      ...
      for iso in args.isovalue:
        ...
        output.append(dir)
        output.append(iso)
        sp.call(['./isodual3D','-multi_isov','-trimesh','-s','-position',pos,'-o', 'out.off', iso,\
        ...
        #repostion
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-reposition', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
        output.append(opsplit[1])
        #lindstrom
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-lindstrom', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
        output.append(opsplit[1])
        #allow_conflict
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-allow_conflict', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
        output.append(opsplit[1])
        #centroid_conflcit
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-centroid_conflict', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
        output.append(opsplit[1])
        #clamp_far
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-clamp_far', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
        output.append(opsplit[1])
        #reselectg
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-reselectg', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
        ...
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-reposition','-allow_conflict', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
        ...
        sp.call(['./isodual3D','-trimesh','-s','-position',pos,'-o', 'out.off','-reposition','-clamp_conflict', iso,\
                 'testData/'+infile_temp[0]+'neg.nrrd'])
        sp.call(['./findedge','140','out.off'])
        op=sp.check_output(['./findEdgeCount','-fp','out.line'])
        opsplit=op.split()
