 ...
 ANISOINFO_TYPE  &aniso_info)
{
    ...
    compute_gradH_d_scalar_grid(scalar_grid, iv1, aniso_info.dirc, aniso_info.gradientS_d);
...
//        cout <<"gradientS_d in the direction "<<aniso_info.dirc<<" is ";
//        cout <<"("<<aniso_info.gradientS_d[0]<<" "<<aniso_info.gradientS_d[1]<<" "<<aniso_info.gradientS_d[2]<<")"<<endl;
        cout <<"c in the direction "<<aniso_info.dirc <<" is ";
        cout <<"("<<aniso_info.c[0]<<","<<aniso_info.c[1]<<","<<aniso_info.c[2]<<")"<<endl;
//        cout <<"N fwd diff in direction "<<aniso_info.dirc<<" is ";
//        cout <<"("<<aniso_info.fwd_diff_d_normals[0]<<" "<<aniso_info.fwd_diff_d_normals[1]<<" "<<
//        aniso_info.fwd_diff_d_normals[2]<<")"<<endl;
//        cout <<"fwd diff in direction "<<aniso_info.dirc<<" is ";
//        cout <<"("<<aniso_info.fwd_diff_d<<")"<<endl;
    }
    if (aniso_info.print_gradientH_d_normals)
    {
        cout<<"gradientH_d normals in the direction "<<aniso_info.gradH_d_normals_direc<<" is (";
